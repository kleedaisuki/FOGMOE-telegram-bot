...
| `infrastructure/assistant/tool_operations/*` | 按 retrieval/group/diary/schedule/social/outbound/external 实现 tool capability | catalog 是唯一 metadata source；dispatcher 只管 transaction mode 与 receipt 编排 |
