...
_ASSISTANT_USER_SNAPSHOT_SELECT = (
    ...
    "ON free_account.account_scope = 'user' "
    "AND free_account.owner_id = users.id "
    "AND free_account.token_bucket = 'free' "
    ...
    "ON paid_account.account_scope = 'user' "
    "AND paid_account.owner_id = users.id "
    "AND paid_account.token_bucket = 'paid' "
