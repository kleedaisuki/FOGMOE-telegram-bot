...
DROP TABLE IF EXISTS `ai_user_affection`;

DROP TABLE IF EXISTS `kindness_gifts`;

DROP TABLE IF EXISTS `web_password`;

DROP TABLE IF EXISTS `rpg_player_equipment_stats`;

DROP TABLE IF EXISTS `rpg_shop`;

DROP TABLE IF EXISTS `rpg_player_inventory`;

DROP TABLE IF EXISTS `rpg_player_equipment`;

DROP TABLE IF EXISTS `rpg_items`;

DROP TABLE IF EXISTS `rpg_equipment`;

DROP TABLE IF EXISTS `rpg_characters`;

DROP TABLE IF EXISTS `group_chart_tokens`;
...
DROP TABLE IF EXISTS `user_omikuji`;

DROP TABLE IF EXISTS `group_spam_keywords`;

DROP TABLE IF EXISTS `group_spam_control`;

DROP TABLE IF EXISTS `group_keywords`;

DROP TABLE IF EXISTS `token_swap_requests`;

DROP TABLE IF EXISTS `user_btc_predictions`;

DROP TABLE IF EXISTS `user_stakes`;

DROP TABLE IF EXISTS `verification_tasks`;

DROP TABLE IF EXISTS `group_verification`;
...
DROP TABLE IF EXISTS `chat_records_group`;

DROP TABLE IF EXISTS `permanent_chat_records`;
