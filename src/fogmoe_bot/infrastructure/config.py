...
class AppSettings(BaseSettings):
    ...
    GEMINI_DREAMING_MODEL: str | None = None
    ...
    ZHIPU_DREAMING_MODEL: str | None = None
    ...
    DREAMING_WORKER_COUNT: int = 2
    DREAMING_BATCH_SIZE: int = 4
    DREAMING_SOURCE_BATCH_SIZE: int = 32
    DREAMING_MAX_EVENTS_PER_JOB: int = 64
    DREAMING_MAX_EVIDENCE_CHARS: int = 60_000
    DREAMING_POLL_INTERVAL: float = 1.0
    DREAMING_REFRESH_SECONDS: int = 21600
    DREAMING_PROVIDER_TIMEOUT_SECONDS: int = 60
    DREAMING_ATTEMPT_TIMEOUT_SECONDS: int = 90
    DREAMING_LEASE_SECONDS: int = 120
    DREAMING_MAX_ATTEMPTS: int = 5
    ...
    OPENAI_DREAMING_MODEL: str | None = None
    ...
    OPENROUTER_DREAMING_MODEL: str | None = None
    ...
    AZURE_OPENAI_DREAMING_MODEL: str | None = None
    ...
    SILICONFLOW_DREAMING_MODEL: str | None = None
    ...
    AI_DREAMING_PROVIDER: str | None = None
    AI_DREAMING_FALLBACK_PROVIDER: str | None = None
    ...
    DB_SEARCH_PATH: str = "identity,conversation,context_window,retrieval,user_profile,assistant,economy,moderation,crypto,game,media,admin,public"
...
GEMINI_DREAMING_MODEL = SETTINGS.GEMINI_DREAMING_MODEL
...
ZHIPU_DREAMING_MODEL = SETTINGS.ZHIPU_DREAMING_MODEL
...
DREAMING_WORKER_COUNT = SETTINGS.DREAMING_WORKER_COUNT
DREAMING_BATCH_SIZE = SETTINGS.DREAMING_BATCH_SIZE
DREAMING_SOURCE_BATCH_SIZE = SETTINGS.DREAMING_SOURCE_BATCH_SIZE
DREAMING_MAX_EVENTS_PER_JOB = SETTINGS.DREAMING_MAX_EVENTS_PER_JOB
DREAMING_MAX_EVIDENCE_CHARS = SETTINGS.DREAMING_MAX_EVIDENCE_CHARS
DREAMING_POLL_INTERVAL = SETTINGS.DREAMING_POLL_INTERVAL
DREAMING_REFRESH_SECONDS = SETTINGS.DREAMING_REFRESH_SECONDS
DREAMING_PROVIDER_TIMEOUT_SECONDS = SETTINGS.DREAMING_PROVIDER_TIMEOUT_SECONDS
DREAMING_ATTEMPT_TIMEOUT_SECONDS = SETTINGS.DREAMING_ATTEMPT_TIMEOUT_SECONDS
DREAMING_LEASE_SECONDS = SETTINGS.DREAMING_LEASE_SECONDS
DREAMING_MAX_ATTEMPTS = SETTINGS.DREAMING_MAX_ATTEMPTS
...
WORKING_MEMORY_RESULT_LIMIT = SETTINGS.WORKING_MEMORY_RESULT_LIMIT
WORKING_MEMORY_RESERVED_TOKENS = SETTINGS.WORKING_MEMORY_RESERVED_TOKENS
...
OPENAI_DREAMING_MODEL = SETTINGS.OPENAI_DREAMING_MODEL
...
OPENROUTER_DREAMING_MODEL = SETTINGS.OPENROUTER_DREAMING_MODEL
...
AZURE_OPENAI_DREAMING_MODEL = SETTINGS.AZURE_OPENAI_DREAMING_MODEL
...
SILICONFLOW_DREAMING_MODEL = SETTINGS.SILICONFLOW_DREAMING_MODEL
...
AI_DREAMING_PROVIDER = SETTINGS.AI_DREAMING_PROVIDER
AI_DREAMING_FALLBACK_PROVIDER = SETTINGS.AI_DREAMING_FALLBACK_PROVIDER
