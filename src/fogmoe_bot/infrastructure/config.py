...
class AppSettings(BaseSettings):
    ...
    SCHEDULING_CONNECTION_POOL_SIZE: int = 16
    SCHEDULING_POLL_INTERVAL: float = 1.0
    SCHEDULING_WORKER_COUNT: int = 3
    SCHEDULING_LEASE_SECONDS: int = 1800
    CONVERSATION_CONTEXT_CACHE_CAPACITY: int = 256
    CONVERSATION_CONTEXT_CACHE_TTL_SECONDS: float = 900.0
...
TELEGRAM_GET_UPDATES_CONNECTION_POOL_SIZE = SETTINGS.TELEGRAM_GET_UPDATES_CONNECTION_POOL_SIZE
...
SCHEDULING_CONNECTION_POOL_SIZE = SETTINGS.SCHEDULING_CONNECTION_POOL_SIZE
...
CONVERSATION_CONTEXT_CACHE_CAPACITY = SETTINGS.CONVERSATION_CONTEXT_CACHE_CAPACITY
CONVERSATION_CONTEXT_CACHE_TTL_SECONDS = SETTINGS.CONVERSATION_CONTEXT_CACHE_TTL_SECONDS
