...
from fogmoe_bot.domain.agent_runtime.tools import image_tools
from fogmoe_bot.domain.agent_runtime.tools.models import GenerateImageArgs, parameters_schema
